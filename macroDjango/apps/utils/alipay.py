...
if __name__ == "__main__":
    ...
    alipay = AliPay(
        appid="2016092100562492",
        app_notify_url="http://118.25.95.136:8000",
        app_private_key_path=u"./keys/private_2048.txt",
        alipay_public_key_path=u"./keys/alipay_key_2048.txt",  # 支付宝的公钥，验证支付宝回传消息使用，不是你自己的公钥,
        debug=True,  # 默认False,
        return_url="http://118.25.95.136:8000"
    )
